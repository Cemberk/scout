"""
Drive toolkit that actually sees shared folders + Shared Drives.
...
nothing in Shared Drives. So a standard Scout deployment (SA + folders
shared by humans + files in Shared Drives) returns 0 hits for the most
ordinary "name contains 'X'" query.
...
class ScoutGoogleDriveTools(GoogleDriveTools):
