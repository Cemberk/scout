"""Custom knowledge tool — lets the agent save metadata to scout_knowledge."""
...
def create_update_knowledge(knowledge: Knowledge):
    ...
    def update_knowledge(title: str, content: str) -> str:
        ...
        Use this to record structural information about Scout's context graph:
        ...
        Args:
            title: A descriptive title prefixed with its category
                (e.g. "Schema: scout_projects", "File: brand-voice.md",
